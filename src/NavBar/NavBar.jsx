        ...
        <div className="px-3 md:px-0 max-w-[1240px] mx-auto">
            <div className="flex justify-between items-center py-4">
                ...
                <div className={`flex items-center duration-300 flex-col py-5 md:p-0 text-white md:text-gray-300 bg-opacity-100 top-[100px] bg-black md:bg-transparent w-full text-center md:w-auto md:flex-row gap-6 absolute md:static z-50 ${toggle ? "left-0" : "-left-full"}`}>
                    <ul className="flex flex-col md:flex-row gap-3 font-semibold items-center">
                        <Link className="hover:bg-[#221F39] duration-300 md:text-md rounded-md hover:text-blue-400 p-2 text-md" to="/"><li>Home</li></Link>
                        <Link className="hover:bg-[#221F39] duration-300 md:text-md rounded-md hover:text-blue-400 p-2 text-md" to="/about"><li>About Us</li></Link>
                        <Link className="hover:bg-[#221F39] duration-300 md:text-md rounded-md hover:text-blue-400 p-2 text-md" to="/portfolio"><li>Portfolio</li></Link>
                        <Link className="hover:bg-[#221F39] duration-300 md:text-md rounded-md hover:text-blue-400 p-2 text-md" to="/news"><li>News</li></Link>
